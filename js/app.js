...
window.abrirNivelesFlotante=function(){
  ...
  if(!m){
    ...
    m.innerHTML='<div class="niv-box"><button class="niv-x" title="Cerrar">✕</button>'
      +'<iframe title="Registros de lectura — Nivel de agua" src="niveles.html?embed=1&v=26"></iframe></div>';
...
window.abrirLluviaFlotante=function(){
  ...
  if(!m){
    ...
    m.innerHTML='<div class="niv-box"><button class="niv-x" title="Cerrar">✕</button>'
      +'<iframe title="Registros de lectura — Lluvia" src="lluvia.html?embed=1&v=6"></iframe></div>';
    document.body.appendChild(m);
