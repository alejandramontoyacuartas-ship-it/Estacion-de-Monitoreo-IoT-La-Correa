...
# rango puntos -> (archivo fuente, nombre limpio, nombre a mostrar, institucion)
REPORTES = [
    (1, 10, "1-10. informe_120-IT2307-8323_Informe Tecnico Girardota (1) evento mayo 27 (2).pdf",
            ...
            "Informe Tecnico 120-IT2307-8323 - Girardota - evento 27 may 2023 (puntos 1-10)", "Corantioquia"),
    (11, 11, "11. DAGRAN2025030551343_SOCORRO RANCHO ALEGRE.pdf",
             "DAGRAN2025030551343_Socorro_Rancho_Alegre_p11.pdf",
             "DAGRAN 2025030551343 - Socorro Rancho Alegre (punto 11)", "DAGRAN"),
    (12, 12, "12. 160AN-IT2602-1057. TOTUMO_ASERRIO.pdf",
             "160AN-IT2602-1057_Totumo_Aserrio_p12.pdf",
             "160AN-IT2602-1057 - El Totumo / Aserrio (punto 12)", "Corantioquia"),
    (13, 13, "13. 160AN-COI2410-24668_VSOCORRO.pdf",
             "160AN-COI2410-24668_VSocorro_p13.pdf",
             "160AN-COI2410-24668 - Vereda El Socorro (punto 13)", "Corantioquia"),
    (14, 15, "14 -15 160AN-COI2610-28891.pdf",
             "160AN-COI2610-28891_p14-15.pdf",
             "160AN-COI2610-28891 (puntos 14-15)", "Corantioquia"),
    (16, 16, "16. AMVA COLCER" + chr(0xC1) + "MICAS.pdf",
             "AMVA_Colceramicas_p16.pdf",
             "AMVA - Colceramica S.A. (punto 16)", "AMVA"),
    (17, 17, "17. AMVA SAN ESTEBAN_.pdf",
             "AMVA_San_Esteban_p17.pdf",
             "AMVA - San Esteban (punto 17)", "AMVA"),
    (18, 18, "18. AMVA MANGARRIBA.pdf",
             "AMVA_Manga_Arriba_p18.pdf",
             "AMVA - Manga Arriba (punto 18)", "AMVA"),
]

for lo, hi, src, clean, nombre, inst in REPORTES:
    s = os.path.join(SRC_INF, src)
    if os.path.exists(s):
        shutil.copy2(s, os.path.join(DST_INF, clean)); print("copiado:", clean)
    else:
        print("!! NO existe:", src)
...
def informe_de(num):
    for lo, hi, src, clean, nombre, inst in REPORTES:
        if lo <= num <= hi:
            return "informes/" + clean, nombre, inst
    return "", "", "Sin dato"
...
for pm in re.findall(r'<Placemark>(.*?)</Placemark>', kml, re.S):
    ...
    inf_a, inf_n, inst = informe_de(num)
    feats.append({"type": "Feature",
        "geometry": {"type": "Point", "coordinates": [lon, lat]},
        "properties": {"punto": "P%d" % num, "num": num, "ubicacion": ubic,
            "vereda": limpiar_vereda(ubic), "altitud": alt, "institucion": inst,
...
import collections
print("\npuntos:", len(feats))
print("por institucion:", dict(collections.Counter(f['properties']['institucion'] for f in feats)))
for f in feats:
    p = f['properties']; print(" ", p['punto'], "|", p['institucion'], "|", p['vereda'])
